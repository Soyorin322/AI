# Aiko Event Research Guide v0.0.3
...
```text
docs/research/event/event_research_v0.0.3.md
```
...
```text
Complete Appraisal Schema
        ↓
Salience / Relevance Gate
        ↓
Event-specific Active Dimensions
        ↓
Selective Appraisal
```
...
## 5.5 Emotion / Intention / Behavior
...
7. Emotion / Intention / Behavior
8. Memory Formation
9. Processing Disposition Updates
10. Evidence Accumulation / Long-Term Change
```
